...
package metavr.os.sdk.sample.stereovideo
...
import metavr.view.SurfaceControlExt
import metavr.view.SurfaceViewExt
...
class StereoSurfaceViewActivity : AppCompatActivity(), MediaController.MediaPlayerControl {
  ...
  private fun selectVideoSource(source: StereoVideoResources.VideoSource) {
    ...
    // This is the key Meta VR OS JSDK API demonstrated by the sample: it tells
